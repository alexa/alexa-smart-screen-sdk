...
using namespace alexaClientSDK::captions;

class MockRenderCaptionsInterface : public smartScreenSDKInterfaces::RenderCaptionsInterface {
public:
...
protected:
    ...
    std::shared_ptr<alexaSmartScreenSDK::sampleApp::SmartScreenCaptionPresenter> m_captionPresenter;
};
...
void SmartScreenCaptionPresenterTest::SetUp() {
    ...
    m_captionPresenter =
        std::make_shared<alexaSmartScreenSDK::sampleApp::SmartScreenCaptionPresenter>(m_mockRenderCaptionsInterface);
}
...
TEST_F(SmartScreenCaptionPresenterTest, test_renderEmptyCaptions) {
    ...
    m_captionPresenter->onCaptionActivity(captionFrame, alexaClientSDK::avsCommon::avs::FocusState::FOREGROUND);
}
...
TEST_F(SmartScreenCaptionPresenterTest, test_renderCaptionsWithBackgroundOrNoneFocusState) {
    ...
    m_captionPresenter->onCaptionActivity(captionFrame, alexaClientSDK::avsCommon::avs::FocusState::BACKGROUND);
    m_captionPresenter->onCaptionActivity(captionFrame, alexaClientSDK::avsCommon::avs::FocusState::NONE);
}
