...
class MockMiscStorage : public alexaClientSDK::avsCommon::sdkInterfaces::storage::MiscStorageInterface {
public:
...
protected:
    ...
    std::shared_ptr<alexaSmartScreenSDK::sampleApp::SmartScreenCaptionStateManager> captionManager;
...
void SmartScreenCaptionStateManagerTest::expectTableToExist() {
    ...
    captionManager =
        std::make_shared<alexaSmartScreenSDK::sampleApp::SmartScreenCaptionStateManager>(m_mockMiscStorage);
}
...
/**
 * Toggle captions with current ON setting
 */
TEST_F(SmartScreenCaptionStateManagerTest, test_toggleCaptionSettingWhenOnInDatabase) {
    expectTableToExist();
    ...
    captionManager->toggleCaptions();
}

/**
 * Toggle captions with current ON setting
 */
TEST_F(SmartScreenCaptionStateManagerTest, test_toggleCaptionSettingWhenOffInDatabase) {
    expectTableToExist();
