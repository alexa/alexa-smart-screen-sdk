...
#ifndef ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_LOCALEASSETSMANAGER_H_
#define ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_LOCALEASSETSMANAGER_H_
...
public:
     ...
     */
    static std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::LocaleAssetsManagerInterface>
    createLocaleAssetsManagerInterface(
        const std::shared_ptr<alexaClientSDK::avsCommon::utils::configuration::ConfigurationNode>& configurationNode,
        const std::shared_ptr<alexaClientSDK::acsdkShutdownManagerInterfaces::ShutdownNotifierInterface>&
            shutdownNotifier);
...
private:
    ...
    bool initialize(
        bool enableWakeWord,
        const alexaClientSDK::avsCommon::utils::configuration::ConfigurationNode& configurationNode);
...
#endif  // ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_LOCALEASSETSMANAGER_H_
