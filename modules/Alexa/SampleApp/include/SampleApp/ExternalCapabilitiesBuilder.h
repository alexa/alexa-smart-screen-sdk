...
#ifndef ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_EXTERNALCAPABILITIESBUILDER_H_
...
class ExternalCapabilitiesBuilder
        : public alexaSmartScreenSDK::smartScreenClient::ExternalCapabilitiesBuilderInterface {
public:
    /**
     * Constructor.
     *
     ...
     */
    ExternalCapabilitiesBuilder(std::shared_ptr<alexaClientSDK::avsCommon::utils::DeviceInfo> deviceInfo);
    ...
    ExternalCapabilitiesBuilder& withTemplateRunTime(
        std::shared_ptr<smartScreenCapabilityAgents::templateRuntime::TemplateRuntime> templateRuntime) override;
...
private:
    ...
    std::shared_ptr<smartScreenCapabilityAgents::templateRuntime::TemplateRuntime> m_templateRuntime;
...
#endif  // ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_EXTERNALCAPABILITIESBUILDER_H_
