...
#ifndef ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_CONSOLEPRINTER_H_
#define ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_CONSOLEPRINTER_H_
 ...
 */
class ConsolePrinter : public alexaClientSDK::avsCommon::utils::logger::Logger {
public:
    /**
     * Constructor.
     */
...
private:
     ...
     */
    alexaClientSDK::avsCommon::utils::logger::LogStringFormatter m_logFormatter;
};

}  // namespace sampleApp
}  // namespace alexaSmartScreenSDK

#endif  // ALEXA_SMART_SCREEN_SDK_SAMPLEAPP_INCLUDE_SAMPLEAPP_CONSOLEPRINTER_H_
