...
void StubApplicationAudioPipelineFactory::addSpeakerManager(std::shared_ptr<SpeakerManagerInterface>& speakerManager) {
    if (!speakerManager) {
...
bool StubApplicationAudioPipelineFactory::addApplicationMediaInterfaces(
    ...
    std::vector<std::pair<
        ...
        std::shared_ptr<SpeakerInterface>>> mediaInterfaces) {
    std::lock_guard<std::mutex> lock{m_applicationMediaInterfacesMapMutex};
...
std::shared_ptr<ApplicationMediaInterfaces> StubApplicationAudioPipelineFactory::createApplicationMediaInterfaces(
    ...
    bool enableLiveMode,
    bool isCaptionable,
    ChannelVolumeInterface::Type channelVolumeType,
...
std::shared_ptr<PooledApplicationMediaInterfaces> StubApplicationAudioPipelineFactory::
