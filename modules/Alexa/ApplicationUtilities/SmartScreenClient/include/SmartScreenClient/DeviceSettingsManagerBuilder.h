...
class DeviceSettingsManagerBuilder
        : public alexaClientSDK::settings::SettingsManagerBuilderBase<alexaClientSDK::settings::DeviceSettingsManager> {
public:
    /**
     * Constructor.
     *
...
template <size_t index>
alexaClientSDK::settings::SettingConfiguration<DeviceSettingsManagerBuilder::SettingType<index>>
DeviceSettingsManagerBuilder::getConfiguration() const {
...
#endif  // ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_SMARTSCREENCLIENT_INCLUDE_SMARTSCREENCLIENT_DEVICESETTINGSMANAGERBUILDER_H_
