...
#ifndef ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_SMARTSCREENCLIENT_INCLUDE_SMARTSCREENCLIENT_STUBAPPLICATIONAUDIOPIPELINEFACTORY_H_
#define ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_SMARTSCREENCLIENT_INCLUDE_SMARTSCREENCLIENT_STUBAPPLICATIONAUDIOPIPELINEFACTORY_H_
...
class StubApplicationAudioPipelineFactory
        : public alexaClientSDK::acsdkApplicationAudioPipelineFactoryInterfaces::
...
public:
     ...
     */
    void addCaptionManager(std::shared_ptr<alexaClientSDK::captions::CaptionManagerInterface>& captionManager);
    ...
    bool addApplicationMediaInterfaces(
        ...
        const std::shared_ptr<alexaClientSDK::avsCommon::utils::mediaPlayer::MediaPlayerInterface>& mediaPlayer,
        const std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::SpeakerInterface>& speaker);
    ...
    bool addApplicationMediaInterfaces(
        ...
        std::vector<std::pair<
            ...
            std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::SpeakerInterface>>> mediaInterfaces);

    /// @name ApplicationAudioPipelineFactoryInterface
    /// @{
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ApplicationMediaInterfaces>
    ...
    std::shared_ptr<alexaClientSDK::acsdkApplicationAudioPipelineFactoryInterfaces::PooledApplicationMediaInterfaces>
...
private:
    ...
    std::unordered_map<
        std::string,
        std::vector<std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ApplicationMediaInterfaces>>>
...
#endif  // ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_SMARTSCREENCLIENT_INCLUDE_SMARTSCREENCLIENT_STUBAPPLICATIONAUDIOPIPELINEFACTORY_H_
