...
#ifndef ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_APL_APLCOREGUIRENDERER_H_
#define ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_APL_APLCOREGUIRENDERER_H_
...
public:
     ...
     * Constructor.
     *
     * @param aplOptions The AplOptionsInterface object
     * @param aplCoreConnectionManager Pointer to the APL Core connection manager
     */
    AplCoreGuiRenderer(AplOptionsInterfacePtr aplOptions, AplCoreConnectionManagerPtr aplCoreConnectionManager);
...
private:
    ...
    /**
     * A reference to the AplOptionsInterface object
     */
...
#endif  // ALEXA_SMART_SCREEN_SDK_APPLICATIONUTILITIES_APL_APLCOREGUIRENDERER_H_
