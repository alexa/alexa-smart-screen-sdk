...
#ifndef ALEXA_SMART_SCREEN_SDK_SMARTSCREENSDKINTERFACES_INCLUDE_SMARTSCREENSDKINTERFACES_NAVIGATIONEVENT_H_
#define ALEXA_SMART_SCREEN_SDK_SMARTSCREENSDKINTERFACES_INCLUDE_SMARTSCREENSDKINTERFACES_NAVIGATIONEVENT_H_

namespace alexaSmartScreenSDK {
namespace smartScreenSDKInterfaces {

/// Enumeration of activity events that could be sent from GUI client to AlexaPresentation.
...
#endif  // ALEXA_SMART_SCREEN_SDK_SMARTSCREENSDKINTERFACES_INCLUDE_SMARTSCREENSDKINTERFACES_NAVIGATIONEVENT_H_